...
export declare function parseFormattingSettingsSlice(slice: FormattingSettingsSlice, objectName: string, propertyName: string): visuals.FormattingSlice | undefined;
